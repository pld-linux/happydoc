...
%description -l pl
HappyDoc jest narzêdziem do generowania dokumentacji ze ¼róde³ programów
napisanych w jêzyku Python. Program ten, w przeciwno¶ci do innych aplikacji
tego typu, które musz± uruchomiæ modu³, analizuje strukturê danego modu³u i
na jej podstawie tworzy dokumentacjê.  Pozwala to na generowanie
dokumentacji dla tych modu³ów/programów, które musz± byæ uruchamiane w
odpowiednim ¶rodowisku.
